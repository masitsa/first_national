<head>
    ...
    <!-- prettyPhoto -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/prettyPhoto.css">   
    <!-- Star rating -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/rateit.css">
    <!-- Date picker -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/bootstrap-datetimepicker.min.css">
    <!-- jQuery Gritter -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/jquery.gritter.css">
    <!-- CLEditor -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/jquery.cleditor.css"> 
    <!-- Bootstrap toggle -->
    <link rel="stylesheet" href="<?php echo base_url()."assets/themes/bluish";?>/style/bootstrap-switch.css">
    <!-- Horizontal scroll -->
    <link href="<?php echo base_url()."assets/themes/bluish";?>/style/jquery.horizontal.scroll.css" rel="stylesheet">
    <!-- Main stylesheet -->
